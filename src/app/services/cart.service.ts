...
export class CartService {
  ...
  data: Product[] = [
    { id: 0, name: 'Pizza Salami', price: 8.99, amount: 0, liked: false },
    { id: 1, name: 'Pizza Classic', price: 5.49, amount: 0,liked: false },
    { id: 2, name: 'Sliced Bread', price: 4.99, amount: 0, liked: false },
    { id: 3, name: 'Salad', price: 6.99, amount: 0, liked: false }
  ];
